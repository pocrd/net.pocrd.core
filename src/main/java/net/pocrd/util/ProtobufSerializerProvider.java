...
public class ProtobufSerializerProvider implements Opcodes {
    ...
    //                try {
    //                    File folder = new File(CommonConfig.getInstance().getAutogenPath() + File.separator + "ProtoSerializer" + File.separator);
    //                    if (!folder.exists()) {
    //                        folder.mkdirs();
    //                    }
    //                    fos = new FileOutputStream(CommonConfig.getInstance().getAutogenPath() + File.separator + "ProtoSerializer" + File.separator + className + ".class");
    ...
    //            }
    //
    //            return (Serializer<T>)new PocClassLoader(ProtobufSerializerProvider.class.getClassLoader()).defineClass(className, cw.toByteArray()).newInstance();
    //        } catch (Exception e) {
    ...
    //                        mv.visitMethodInsn(INVOKESTATIC, "net/pocrd/util/ProtobufSerializerProvider", "writeXmlString", "(Ljava/io/OutputStream;Ljava/lang/String;)V");
    ...
    //                        mv.visitMethodInsn(INVOKESTATIC, "net/pocrd/util/ProtobufSerializerProvider", "getSerializer", "(Ljava/lang/Class;)Lnet/pocrd/define/Serializer;");
    ...
    //                        mv.visitVarInsn(ILOAD, local_size);
    //                        Label label_empty = new Label();
    //                        Label label_goon = new Label();
    //                        mv.visitJumpInsn(IFGT, label_goon);
    //                        if (n + 1 == fdsl) {
    //                            writeByteArray(mv, ("\"" + name + "List\":null").getBytes(ConstField.UTF8), 2);
    //                        } else {
    //                            writeByteArray(mv, ("\"" + name + "List\":null,").getBytes(ConstField.UTF8), 2);
    //                        }
    //                        mv.visitJumpInsn(GOTO, label_empty);
    //                        mv.visitLabel(label_goon);
    ...
    //                        mv.visitVarInsn(ILOAD, local_i);
    //                        mv.visitMethodInsn(INVOKEVIRTUAL, t_className, getter, "(I)Ljava/lang/String;");
    //                        mv.visitMethodInsn(INVOKESTATIC, "net/pocrd/util/ProtobufSerializerProvider", "writeJsonString", "(Ljava/io/OutputStream;Ljava/lang/String;)V");
    //                        writeByteArray(mv, ("\",").getBytes(ConstField.UTF8), local_out);
    //                        mv.visitIincInsn(local_i, 1);
    //                        mv.visitLabel(label_toLoop);
    //                        mv.visitVarInsn(ILOAD, local_i);
    ...
    //                        Label label_null = new Label();
    //                        Label label_goon = new Label();
    //                        mv.visitJumpInsn(IFNONNULL, label_goon);
    //                        if (n + 1 == fdsl) {
    //                            writeByteArray(mv, ("\"" + name + "\":null").getBytes(ConstField.UTF8), 2);
    //                        } else {
    //                            writeByteArray(mv, ("\"" + name + "\":null,").getBytes(ConstField.UTF8), 2);
    //                        }
    //                        mv.visitJumpInsn(GOTO, label_null);
    //                        mv.visitLabel(label_goon);
    //                        writeByteArray(mv, ("\"" + name + "\":\"").getBytes(ConstField.UTF8), local_out);
    //                        mv.visitVarInsn(ALOAD, local_out);
    //                        mv.visitVarInsn(ALOAD, local_obj);
