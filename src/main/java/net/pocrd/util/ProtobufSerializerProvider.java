            ...
            switch (t) {
                ...
                case STRING:
                    if (fd.isRepeated()) {
                        ...
                        mv.visitMethodInsn(INVOKESTATIC, "net/pocrd/util/ProtobufSerializerProvider", "writeXmlString",
                ...
                case MESSAGE:
                    if (fd.isRepeated()) {
                        ...
                        mv.visitMethodInsn(INVOKESTATIC, "net/pocrd/util/ProtobufSerializerProvider", "getSerializer",
            ...
            switch (t) {
                ...
                case STRING:
                    if (fd.isRepeated()) {
                        ...
                        mv.visitVarInsn(ILOAD, local_i);
                        mv.visitMethodInsn(INVOKEVIRTUAL, t_className, getter, "(I)Ljava/lang/String;");
                        mv.visitMethodInsn(INVOKESTATIC, "net/pocrd/util/ProtobufSerializerProvider", "writeJsonString",
                                "(Ljava/io/OutputStream;Ljava/lang/String;)V");
                        writeByteArray(mv, ("\",").getBytes(ConstField.UTF8), local_out);
                        mv.visitIincInsn(local_i, 1);
                        mv.visitLabel(label_toLoop);
