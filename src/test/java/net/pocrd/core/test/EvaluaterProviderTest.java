...
public class EvaluaterProviderTest {
    ...
    public void testEvaluater() {
        ...
        org.junit.Assert.assertEquals(a.caller1.roles, b.getCaller1().roles);
        ...
        org.junit.Assert.assertEquals(a.getCaller2().roles, b.caller2.roles);
        ...
        org.junit.Assert.assertEquals(a.getCaller3().roles, b.getCaller3().roles);
