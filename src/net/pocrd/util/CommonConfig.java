...
public class CommonConfig {
	...
	static {
		...
		if (tmp == null) {
			...
			if (isDebug) {
				tmp.c3p0config = new C3P0Config(
						"com.mysql.jdbc.Driver",
						"jdbc:mysql://localhost/test?useUnicode=true;characterset=utf-8",
						"gkq", "gkq1990", 5, 10, 10, 20, 5, 5);
			} else {
				tmp.c3p0config = new C3P0Config(
						"com.mysql.jdbc.Driver",
						"jdbc:mysql://localhost/gougoudai?useUnicode=true;characterset=utf-8",
