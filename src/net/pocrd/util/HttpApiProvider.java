    ...
    public static HttpApiExecuter getApiExecuter(String name, ApiMethodInfo method) {
        try {
            ...
            if (CompileConfig.isDebug) {
                ...
                try {
                    File folder = new File(CommonConfig.getInstance().autogenPath + File.separator + "ApiExecuter" + File.separator);
                    if (!folder.exists()) {
                        folder.mkdirs();
                    }
                    fos = new FileOutputStream(CommonConfig.getInstance().autogenPath + File.separator + "ApiExecuter" + File.separator + name + ".class");
