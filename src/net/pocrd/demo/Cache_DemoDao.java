...
public class Cache_DemoDao extends DemoDao
{
  ...
  {
    String str = "v1.0|getDemoEntity|int[]|" + paramDouble + "|" + paramLong + "|";
    CacheManager4Redis localCacheManager4Redis = CacheManager4Redis.getSingleton();
  ...
  {
    String str = "v1.0|getDemoEntity|net.pocrd.demo.DemoEntity|" + paramInt + "|" + paramString + "|" + paramBoolean + "|" + paramByte + "|" + paramShort + "|" + paramChar + "|" + paramLong + "|" + paramFloat + "|" + paramDouble + "|";
    CacheManager4Redis localCacheManager4Redis = CacheManager4Redis.getSingleton();
    Object localObject = localCacheManager4Redis.get(str);
    if (localObject == null)
    {
  ...
  public int[] getDemoEntity(int[] paramArrayOfInt, DemoEntity[] paramArrayOfDemoEntity, DemoDao.Test paramTest, int paramInt)
  {
    String str = "v1.0|getDemoEntity|int[]|" + StringHelper.toString(paramArrayOfInt) + "|" + StringHelper.toString(paramArrayOfDemoEntity) + "|" + paramTest + "|" + paramInt + "|";
    CacheManager4Redis localCacheManager4Redis = CacheManager4Redis.getSingleton();
    Object localObject = localCacheManager4Redis.get(str);
    if (localObject == null)
    {
      int[] arrayOfInt = super.getDemoEntity(paramArrayOfInt, paramArrayOfDemoEntity, paramTest, paramInt);
      if (arrayOfInt != null)
      {
        localCacheManager4Redis.set(str, arrayOfInt, 100);
        return arrayOfInt;
